	...
	return (
		// <section className="flex flex-wrap">
			<section className="flex flex-wrap justify-around lg:w-1/2 m-5">
				...
				<div className="text-xl leading-loose border-2 border-stone-900 rounded-t-2xl rounded-bl-2xl nav-btn-solutions m-3">
					<Link
				...
				<div className="text-xl leading-loose border-2 border-stone-900 rounded-t-2xl rounded-bl-2xl nav-btn-ourwork m-3">
				...
				<div className="text-xl leading-loose border-2 border-stone-900 rounded-t-2xl rounded-bl-2xl nav-btn-contact m-3">
